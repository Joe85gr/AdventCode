...
namespace Day4
{
    ...
    { 
        ...
        private static bool CheckIfRowWins(IEnumerable<string> board, ICollection<string> extracted)
        {
            return board
                .Select(b => b.Split(' ')
        ...
        private static bool CheckIfColumnWins(IReadOnlyCollection<string> board, ICollection<string> extracted)
        {
